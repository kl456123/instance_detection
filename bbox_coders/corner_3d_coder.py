...
@BBOX_CODERS.register('corners_3d')
class Corner3DCoder(object):
    def __init__(self, config):
        pass

    def decode_batch(self, encoded_corners_3d_all, auxiliary_dict):
        ...
        for batch_ind in range(batch_size):
            orients_batch.append(
                self.decode(encoded_corners_3d_all[batch_ind],
                            final_boxes_2d[batch_ind], p2[batch_ind]))
        return torch.stack(orients_batch, dim=0)

    def decode(self, encoded_corners_3d_all, final_boxes_2d, p2):
        """
        """
    ...
    def encode(self, label_boxes_3d, label_boxes_2d, p2):
        """
        ...
        return torch.cat(
            [local_corners_3d, encoded_C_2d, instance_depth], dim=-1)
